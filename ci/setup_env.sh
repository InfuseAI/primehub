...
# Install node
curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v${NVM_VERSION}/install.sh | bash && bash -c 'source ~/.bashrc && nvm install v'${NODEJS_VERSION}' && npm install @cucumber/cucumber puppeteer@15.5.0 chai cucumber-html-reporter'
