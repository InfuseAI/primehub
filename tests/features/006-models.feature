...
Feature: Model Deployment
  ...
  Scenario: User can create deployment
    ...
    And I type "infuseai/model-tensorflow2-mnist:v0.1.0" to element with xpath "//div[@id='modelImage']"
  ...
  Scenario: User can update deployment
    ...
    And I type "infuseai/model-tensorflow2-mnist:v0.2.0" to element with xpath "//div[@id='modelImage']"
  ...
  Scenario: Model URI: User can create deployment
    ...
    And I choose radio button with name "test-instance-type"
    And I type "infuseai/tensorflow2-prepackaged_rest:v0.4.2" to element with xpath "//div[@id='modelImage']"
