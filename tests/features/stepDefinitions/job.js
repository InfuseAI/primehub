...
defineStep("I {string} the {string} in Schedule", async function(action, entry) {
  ...
  await this.takeScreenshot(`I-${action}-the-${entry}-in-Schedule`);
});
